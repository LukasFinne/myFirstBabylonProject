...
export class StandardMaterials {
  ...
  CreateGroundMaterial(): StandardMaterial {
    ...
    const diffuseTex = new Texture(
      "./textures/cobble/cobble_diff.jpg",
      this.scene
    );
    ...
    const normalTex = new Texture(
      "./textures/cobble/cobble_normal.jpg",
      this.scene
    );
    groundMat.bumpTexture = normalTex;
    texArray.push(normalTex);

    const aoTex = new Texture("./textures/cobble/cobble_ao.jpg", this.scene);
    groundMat.ambientTexture = aoTex;
    texArray.push(aoTex);

    const specText = new Texture(
      "./textures/cobble/cobble_spec.jpg",
      this.scene
    );
